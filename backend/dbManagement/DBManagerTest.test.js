...
describe('DBManager Tests', () => {
    ...
    test('Initialization', async () => {
        ...
        await expect(TestManager.dbExecute(schema)).resolves.toBe("dbExecute: Success");

        await TestManager.dbClose();
    });
    ...
    describe('Database Manipulation', () => {
        ...
        test('Manipulation', async () => {
            ...
            await expect(TestManager.dbExecute("DROP TABLE users",[])).resolves.toBe("dbExecute: Success");
        });
